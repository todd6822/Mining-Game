...
namespace WindowsFormsApplication1 {
    ...
    public partial class scoreDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TableRow AddTableRow(int id, string fName, string lName, string score) {
...
namespace WindowsFormsApplication1.scoreDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table] WHERE (([id] = @Original_id) AND ((@IsNull_fName = 1 AND [fName] IS NULL) OR ([fName] = @Original_fName)) AND ((@IsNull_lName = 1 AND [lName] IS NULL) OR ([lName] = @Original_lName)) AND ((@IsNull_score = 1 AND [score] IS NULL) OR ([score] = @Original_score)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([id], [fName], [lName], [score]) VALUES (@id, @fName, " +
                "@lName, @score);\r\nSELECT id, fName, lName, score FROM [Table] WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [id] = @id, [fName] = @fName, [lName] = @lName, [score] = @score WHERE (([id] = @Original_id) AND ((@IsNull_fName = 1 AND [fName] IS NULL) OR ([fName] = @Original_fName)) AND ((@IsNull_lName = 1 AND [lName] IS NULL) OR ([lName] = @Original_lName)) AND ((@IsNull_score = 1 AND [score] IS NULL) OR ([score] = @Original_score)));
SELECT id, fName, lName, score FROM [Table] WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApplication1.Properties.Settings.Default.ScoresConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, fName, lName, score FROM dbo.[Table]";
        ...
        public virtual int Fill(scoreDataSet.TableDataTable dataTable) {
        ...
        public virtual scoreDataSet.TableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            scoreDataSet.TableDataTable dataTable = new scoreDataSet.TableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(scoreDataSet.TableDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_fName, string Original_lName, string Original_score) {
        ...
        public virtual int Insert(int id, string fName, string lName, string score) {
        ...
        public virtual int Update(int id, string fName, string lName, string score, int Original_id, string Original_fName, string Original_lName, string Original_score) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string fName, string lName, string score, int Original_id, string Original_fName, string Original_lName, string Original_score) {
            return this.Update(Original_id, fName, lName, score, Original_id, Original_fName, Original_lName, Original_score);
        }
    }
