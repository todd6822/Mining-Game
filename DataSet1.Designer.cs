...
namespace WindowsFormsApplication1 {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TableRow AddTableRow(string fName, string lName, string score) {
...
namespace WindowsFormsApplication1.DataSet1TableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([fName], [lName], [score]) VALUES (@fName, @lName, @sc" +
                "ore);\r\nSELECT id, fName, lName, score FROM [Table] WHERE (id = SCOPE_IDENTITY())" +
                "";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [fName] = @fName, [lName] = @lName, [score] = @score WHERE (([id] = @Original_id) AND ((@IsNull_fName = 1 AND [fName] IS NULL) OR ([fName] = @Original_fName)) AND ((@IsNull_lName = 1 AND [lName] IS NULL) OR ([lName] = @Original_lName)) AND ((@IsNull_score = 1 AND [score] IS NULL) OR ([score] = @Original_score)));
SELECT id, fName, lName, score FROM [Table] WHERE (id = @id)";
        ...
        public virtual int Insert(string fName, string lName, string score) {
            if ((fName == null)) {
        ...
        public virtual int Update(string fName, string lName, string score, int Original_id, string Original_fName, string Original_lName, string Original_score, int id) {
            if ((fName == null)) {
        ...
        public virtual int Update(string fName, string lName, string score, int Original_id, string Original_fName, string Original_lName, string Original_score) {
            return this.Update(fName, lName, score, Original_id, Original_fName, Original_lName, Original_score, Original_id);
        }
    }
